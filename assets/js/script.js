...
// when the submit button on the initials input is clicked, the followin fuction occurs
submitScore.onclick = (event) => {
    saveScore(event);
}

// The questions are asked in the quiz
...
// When a question is clicked, a correct or incorrect alert is given to the user
...
// When the user finishes the quiz, alert is given of score ranking
...
// When the quiz is initiated, a countdown of 1 minute begins 
var time = 59
function startTimer() {
...
// When the user saves their score, the following fuction occurs
